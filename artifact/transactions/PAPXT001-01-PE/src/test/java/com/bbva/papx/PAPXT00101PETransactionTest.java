...
/**
 * Test for transaction PAPXT00101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PAPXT00101PETest.xml" })
public class PAPXT00101PETransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PAPXT00101PETransactionTest.class);

	@Autowired
	private PAPXT00101PETransaction transaction;
